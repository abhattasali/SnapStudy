...
- (void)generateFramebuffer;
{
    runSynchronouslyOnVideoProcessingQueue(^{
        ...
        else
        {
            ...
            glTexImage2D(GL_TEXTURE_2D, 0, _textureOptions.internalFormat, (int)self->_size.width, (int)self->_size.height, 0, _textureOptions.format, _textureOptions.type, 0);

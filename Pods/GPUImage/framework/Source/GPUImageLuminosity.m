...
- (id)init;
{
    ...
    runSynchronouslyOnVideoProcessingQueue(^{
        ...
        secondFilterTexelHeightUniform = [self->secondFilterProgram uniformIndex:@"texelHeight"];
...
- (void)extractLuminosityAtFrameTime:(CMTime)frameTime;
{
    runSynchronouslyOnVideoProcessingQueue(^{
        ...
        glReadPixels(0, 0, (int)finalStageSize.width, (int)finalStageSize.height, GL_RGBA, GL_UNSIGNED_BYTE, self->rawImagePixels);

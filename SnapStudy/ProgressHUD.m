...
//-------------------------------------------------------------------------------------------------------------------------------------------------
{
	if (self.alpha == 0)
	{
		...
		[UIView animateWithDuration:0.15 delay:0 options:options animations:^{
            self->toolbarHUD.transform = CGAffineTransformScale(toolbarHUD.transform, 1/1.4, 1/1.4);
...
//-------------------------------------------------------------------------------------------------------------------------------------------------
{
	if (self.alpha == 1)
	{
		...
		[UIView animateWithDuration:0.15 delay:0 options:options animations:^{
            self->toolbarHUD.transform = CGAffineTransformScale(toolbarHUD.transform, 0.7, 0.7);
